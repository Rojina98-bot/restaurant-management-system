    ...
    <div className={`${styles.menuBody} px-3`}>
            <table className={`${styles.table} px-3 `}>
                ...
                <tr className={styles.tr}>
                    ...
                    {
                    plattar && plattar.map(record =>{
                        return(
                            <tr className="{styles.tr}">
                            <td className={`${styles.td} ${styles.featureImage}`}>{record.name}
                            <p className={styles.text}>{record.des}</p>
                            <img src ={record.src}/></td>
                            <td className={styles.td}>{record.price}</td>
                            <td className={styles.td} ><button className={`btn btn-dark ${styles.order}`}  value={record.name} onClick={buttonHandler}>order</button></td>
                        </tr>
                        )
                    })}  
                     <tr className={`styles.tr`}>
                    ...
                    {
                    NepaliIndian && NepaliIndian.map(record =>{
                        return(
                            <tr className={`${styles.tr}`}>
                            <td className={`${styles.td} ${styles.featureImage}`}>{record.name}
                            <p className={styles.text}>{record.des}</p>
                   ...
                   {/* 
                    <tr className={`${styles.tr} ${styles.featuredImage}`>
